...
\begin{document}
  ...
  \vspace{0.05in}
	 \centerline{{\large \textbf{Experience}}}
	   ...
	   \end{tabular*}
	   \begin{itemize}
	   \item Maintained EC2-based Django web app where users create custom collections of video from around the web, including video website scraping and API consumption code and integrating PayPal IPN.
	   \end{itemize}
